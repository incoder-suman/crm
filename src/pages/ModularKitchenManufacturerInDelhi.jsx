...
const kitchenItems = [
  ...
  { src: mod3, alt: "Custom Modular Kitchen Delhi", title: "Modern Parallel Kitchen" },
  { src: mod4, alt: "Luxury Modular Kitchen Delhi", title: "Modern U-Shaped Kitchen" },
  { src: mod5, alt: "Kitchen Furniture Manufacturer Delhi", title: "Minimal L-Shaped Kitchen" },
  { src: mod6, alt: "Modular Kitchen Interiors Delhi", title: "Modern U-Shaped Kitchen" },
];

const ModularKitchenManufacturerInDelhi = () => {
  return (
    <>
      <SEO
        title="Modular Kitchen Manufacturer in Delhi | Custom Kitchen Design "
        description="DFurniture is a leading Modular Kitchen Manufacturer in Delhi offering smart, stylish & durable kitchen designs with customized solutions."
        ...
        url="https://www.dfurniture.in/modular-kitchen-manufacturer-in-delhi/"
      />
      ...
      <section className="px-4 sm:px-10 lg:px-20 text-center">
        <h1 className="text-primary mt-3 font-extrabold text-[28px] sm:text-[36px] lg:text-[45px] leading-tight">
          Modular Kitchen Manufacturer in Delhi | Premium Custom Kitchen Design
          by DFurniture
        </h1>
        <p className="text-black/80 mt-5">
          A kitchen is the heart of a home, where design, functionality, and
          lifestyle converge. Dfurniture, we specialize in premium{" "}
          <stong>Modular Kitchen Manufacturer in Delhi</stong>, creating spaces
          that combine modern elegance, ergonomic design, and lasting quality.
        </p>
        <p className="text-black/80 mt-5">
          ...
          <a href=" https://www.dfurniture.in/modular-kitchen/" target="_blank">
            <strong className="text-primary">Custom Modular Kitchens</strong>
          </a>{" "}
          are meticulously designed to optimize space, enhance usability, and
          elevate the aesthetic appeal of your home.
        </p>
      </section>
      ...
      <section className="px-4 sm:px-10 lg:px-20 pb-5">
        <h2 className="text-primary mt-3 font-extrabold text-[24px] sm:text-[30px] leading-tight">
          Why DFurniture is a Preferred Modular Kitchen Manufacturer in Delhi?
        </h2>
        <p className="text-black/80 mt-3">
          DFurniture stands among the reliable names in modular kitchen
          manufacturing due to our commitment to quality, precision, and
...
export default ModularKitchenManufacturerInDelhi;
