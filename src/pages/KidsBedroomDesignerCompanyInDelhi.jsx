...
const KidsBedroomDesignerCompanyInDelhi = () => {
  return (
    <>
      <SEO
        title="Kids Bedroom Designer Company in Delhi | Dfurniture  "
        description="Dfurniture offers kids bedroom interior design in Delhi with creative, safe, and functional spaces, including custom furniture and modern themes."
        keywords="kids bedroom designer company in Delhi, kids bedroom interior designers Delhi, kids room interior design Delhi, children bedroom designer Delhi, kids bedroom interiors in Delhi, best kids bedroom designer Delhi, kids room furniture Delhi, custom kids bedroom interiors Delhi, modern kids bedroom design Delhi, kids bedroom renovation Delhi "
        url="https://www.dfurniture.in/kids-bedroom-designer-company-in-delhi/"
      />
      ...
      <section className="px-4 sm:px-10 lg:px-20 text-center">
        ...
        <p className="text-black/80 mt-5 text-sm sm:text-base">
          ...
          specializing in custom kids bedroom interiors, kids room design, and
          modern children's bedroom furniture solutions. We create beautifully
          designed, functional, and safe spaces that perfectly balance
          creativity, comfort, and practicality for your child.
        </p>
      </section>
      ...
      <section className="pt-8 pb-12 px-4 sm:px-10 lg:px-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            {
              src: kids1,
              alt: "kids bedroom designer company in Delhi",
              title: "Scandinavian Kids Bedroom",
            },
            {
              src: kids2,
              alt: "kids bedroom interior designers Delhi",
              title: "Modern Kids Bedroom",
            },
            {
              src: kids3,
              alt: "kids room interior design Delhi",
              title: "Contemporary Kids Bedroom",
            },
            {
              src: kids4,
              alt: "children bedroom designer Delhi",
              title: "Modern Kids Bedroom",
            },
            {
              src: kids5,
              alt: "kids bedroom interiors in Delhi",
              title: "Modern Kids Bedroom",
            },
            {
              src: kids6,
              alt: "kids6",
              title: "Apple Tree Theme Modern Kids Bedroom",
            },
          ].map(({ src, alt, title }) => (
            <div
              key={alt}
      ...
      <section className="px-4 sm:px-10 lg:px-20 pb-5">
        ...
        <p className="text-black/80 mt-1 text-sm sm:text-base">
          We design <strong>modern kids bedrooms in Delhi</strong> that
          encourage creativity, learning, and comfort. Whether you want a{" "}
          <strong>
...
export default KidsBedroomDesignerCompanyInDelhi;
